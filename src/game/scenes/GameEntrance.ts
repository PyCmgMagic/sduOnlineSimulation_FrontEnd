...
export class GameEntrance extends Scene{
    ...
    private createOperateButtons() {
        ...
        const backImage = this.add.image(25, -10, 'return-button');
        const text_back = this.add.text(0, 0, "", {
        })
    ...
    private createProgressBar() {
        ...
        this.progressBarContainer = progressBar.container; // 存储进度条容器引用
        
        // 美化进度文本
        this.progressText = this.add.text(progressBarX, progressBarY + 35, '进度: 0%', {
            fontSize: '18px',
